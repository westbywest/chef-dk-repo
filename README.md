...
This is a demonstation repo created from Chef Development Kit using "chef generate repo" command.  It has not tested, so it may empty your fridge of all food and thereafter harass a kitten.
